...
!! begin mod 
                            run_ITDDFT_        =>  run_ITDDFT, &
                            extensive_ITDDFT_  =>  extensive_ITDDFT, &
                            g_dependant_dtau_  =>  g_dependant_dtau, &
                            switch_tr_         =>  switch_tr, &
                            switch_iter_       =>  switch_iter, &
                            dtau_              =>  dtau, &
                            freeze_band_       =>  freeze_band, &
!! end mod
...
!! begin mod
                               run_ITDDFT, extensive_ITDDFT, g_dependant_dtau, &
                               switch_tr, switch_iter, dtau, freeze_band,      &
!! end mod
